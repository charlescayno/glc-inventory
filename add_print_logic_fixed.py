...
# Instead of re.sub, we will just use basic python replace for the listener
listener_replacer = """
...
# Wait, in the first re.sub I didn't have \d.
def replacer(m):
...
js = js.replace('historyListContainer.appendChild(div);', listener_replacer)
